...
public class OrderService {
    ...
    public OrderService(WarehouseRepository productRepository, BonusClientRepository bonusClientRepository) {
...
//            var optionalProduct = productRepository.findByIdShopAndProductType(coffeeShopId, product.getKey());
